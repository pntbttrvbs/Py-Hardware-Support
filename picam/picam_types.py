...
PicamParameter = {
    ...
    "InternalShutterType": PI_V("Enumeration", "None" , 139),
    "InternalShutterStatus": PI_V("Enumeration", "None" , 153),
    "ExternalShutterType": PI_V("Enumeration", "None" , 152),
    "ExternalShutterStatus": PI_V("Enumeration", "None" , 154),
    "ActiveShutter": PI_V("Enumeration", "Collection",  155),
    "InactiveShutterTimingModeResult": PI_V("Enumeration", "None" , 156),
    ...
    "Vacuum Status": PI_V("Enumeration", "None", 165)
}
